...
| `profile.jsx` | **Source** — profile React components (Header, Hero, SystemsIndex, Stance, SystemDetail, Footer) |
| `tweaks-panel.jsx` | **Source** — reusable in-page Tweaks panel (mode/accent/section toggles) |
| `dist/*.js` | The two files above, compiled — this is what `index.html` loads (generated by `npm run build:js`; do not hand-edit) |
| `vendor/*.js` | Self-hosted React + ReactDOM UMD builds, copied from the pinned npm packages (generated; do not hand-edit) |
