...
const REPOS = [
  {
    ...
    tagline: "Grades AI agent output against checks you define, and writes up the evidence behind each score.",
  ...
  },
  {
    ...
    eyebrow: "LIBRARY",
    name: "executionkit",
    tagline: "A Python library of LLM calling patterns — voting, retry-and-refine, tool loops, structured output — with no dependencies outside the standard library.",
  ...
  },
  {
    ...
    tagline: "A local what-if simulator for project budgets: an AI reads your question, and tested code does all the math.",
    cmd: "npm start",
    glyph: "planet-chart",
